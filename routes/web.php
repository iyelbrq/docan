...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/lupa-password', [AuthController::class, 'sendResetLink'])->middleware('throttle:15,1')->name('password.email');
    Route::get('/reset-password/{token}', [AuthController::class, 'showResetPassword'])->name('password.reset');
    Route::post('/reset-password', [AuthController::class, 'resetPassword'])->middleware('throttle:15,1')->name('password.update');
    Route::get('/daftar', [AuthController::class, 'showRegister'])->name('register');
    Route::post('/daftar/cek-email', [AuthController::class, 'checkRegistrationEmail'])->middleware('throttle:40,1')->name('register.email.check');
    Route::post('/daftar/cek-sf-code', [AuthController::class, 'checkRegistrationSalesForceCode'])->middleware('throttle:40,1')->name('register.sf-code.check');
    Route::post('/daftar', [AuthController::class, 'register'])->middleware('throttle:20,1')->name('register.submit');
});
